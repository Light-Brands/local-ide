 ...
 * Include this in your app to enable component selection from the IDE
 *
 * Usage: Add <script src="/component-selector-bridge.js" defer></script> to your layout
 */
(function() {
  ...
  function getComponentPath(el) {
    ...
    while (current && current !== document.body) {
      const name = current.getAttribute('data-component')
        ...
        || (current.getAttribute('data-testid') ? current.getAttribute('data-testid').replace(/-/g, ' ') : null);
